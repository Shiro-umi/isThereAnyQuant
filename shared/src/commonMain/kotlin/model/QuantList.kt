...
data class Quant(
    ...
    val targetDate: String = kotlin.time.Clock.System.todayIn(TimeZone.currentSystemDefault()).toString().replace("-", ""),
    val triggerTime: Long = kotlin.time.Clock.System.now().toEpochMilliseconds(),

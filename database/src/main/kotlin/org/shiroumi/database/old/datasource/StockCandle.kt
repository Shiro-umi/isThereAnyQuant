...
//import org.shiroumi.database.old.table.AdjFactorTable
//import org.shiroumi.database.old.table.Candle
//import org.shiroumi.database.old.table.DailyCandleTable
...
//            Candle.Companion.all().orderBy(DailyCandleTable.tradeDate to SortOrder.DESC).limit(1).firstOrNull()
//        }?.tradeDate ?: "19900101"
//        val dates = tushare.getCalendar()!!.items.filter { (exchange, date, isOpen, preTradingDate) ->

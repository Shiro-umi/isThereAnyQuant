...
- 实施 TodoList（**SSOT**）：`docs/architecture/backtest-engine-todolist.md` —— 任何回测模块的实现/重构都必须先在 TodoList 中找到对应条目；条目完成必须立即勾选并追加 _日期 · 提交 · 摘要_
